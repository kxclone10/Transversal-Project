...
class Externe3 extends StatelessWidget{
  const Externe3({Key? key}) : super(key: key);
              ...
              child: ElevatedButton(
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    Navigator.push(
                        context, MaterialPageRoute(builder: (context) => Externe4()));
                  }
                },
  ...
  Widget build(BuildContext context){
    return AppBar(
      leading: IconButton(
        ...
        onPressed:() {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => const Externe2()));
        },
      ),
