...
class Depot2 extends StatelessWidget{
  const Depot2({Key? key}) : super(key: key);
...
class MyInputField extends State<InputSection>{
  ...
  @override
  Widget build(BuildContext context){
    String operateur = 'wave';                            // variable concernant l'opérateur
    return Form(
        key: _formKey,
        child: Column(
              ...
              child: ElevatedButton(
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    Navigator.push(
                        context, MaterialPageRoute(builder: (context) => const Depot3()));
                  }
                },
