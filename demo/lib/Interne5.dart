...
class Interne5 extends StatelessWidget{
  @override
...
class MyInputField extends State<InputSection>{
  ...
  Widget build(BuildContext context){
    ...
    String receveur = 'Abdou SAKHO';                        // ici qu'il faut récupérer le nom  du receveur
    return Form(
        key: _formKey,
        child: Column(
          ...
          children: [
            Padding(
              ...
              child:  Text(
                'Votre transfert de $montant FCFA à $receveur a bien réussi !',
